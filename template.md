### Sprints-manual
This document is copied from PyCon PH's repository https://github.com/pythonph/sprint-manual
Thanks their generousity. :)
...
### **What is Sprints of PyCon TW?**

Sprints is a day-long, community-driven activity where programmers of all skill levels contribute to Open Source Software (OSS).

* Open to beginners.
* You can contribute through code, documentation, tutorials, meeting procedures,or by starting a new open-source project.
...
* We are aiming to have a *“chill”* atmosphere. We want the Sprints to be a contrast with the non-stop talks and workshops during the main event.
...
### **Which room will the Sprint be held at and what is the maximum headcount?**
...
* Figure out how to communicate with the OSS core/maintainer team (e.g., Discord, IRC, forums).
